...
>
    ...
    <div class="absolute bottom-6 right-6 md:bottom-10 md:right-10 z-50 flex items-center gap-3 md:gap-4">
        <a href="#whatsapp" aria-label="WhatsApp" class="p-2.5 md:p-3 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full text-white hover:bg-[#F5D0B5] hover:text-neutral-900 transition-colors">
            <svg class="w-5 h-5 md:w-5.5 md:h-5.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
        ...
        <a href="#linkedin" aria-label="LinkedIn" class="p-2.5 md:p-3 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full text-white hover:bg-[#F5D0B5] hover:text-neutral-900 transition-colors">
            <svg class="w-5 h-5 md:w-5.5 md:h-5.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
